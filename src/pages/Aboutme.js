  ...
  import DynamanicCarousel from '../components/DynamanicCarousel';
  ...
  const Aboutme = () => {
    const Data=[
      {
        "url":"https://c0.wallpaperflare.com/preview/100/857/100/united-states-new-york-flatiron-building-slant.jpg",
        "title":"The Title",
        "desc":"This is the description for the image which shows up towards the bottom",
      },  
      {
        "url":"https://c0.wallpaperflare.com/preview/100/857/100/united-states-new-york-flatiron-building-slant.jpg",
        "title":"The Title",
      ...
      return (
          ...
          <div className="min-h-screen    flex-row lg:flex space-x-0 md:space-x-32">
              ...
              <img src="/images/profile.jpg"   className="mx-auto h-52 w-auto 0 rounded-full object-cover" alt="" />
  ...
  <div className="flex align-middle justify-center p-9">
  <Link to={{ pathname: "https://stackoverflow.com/questions/53538992/loading-dynamic-images-fetched-using-api-in-react-responsive-carousel-react" }} target="_blank"  > <button className="bg-purple-600 text-lg text-white rounded-md p-6">Thanks to StackOverflow xD </button></Link>
  </div>
              <div className="w-full h-full">
                {details &&
                <DynamanicCarousel data={details}/>
  }
